...
var hopDesc = {
  ...
  "Chinook CGX":              "元品種の香りキャラクターを凝縮した濃縮加工品(Cryo/CGX等)。基本的なアロマ傾向は元品種(Chinook)と同じ。",
  "Citra":                    "グレープフルーツ・ライム・パッションフルーツ・ライチが炸裂。現代ヘイジーIPAの代名詞。",
  "Citra Cryo":               "元品種の香りキャラクターを凝縮した濃縮加工品(Cryo/Incognito/DynaBoost等)。基本的なアロマ傾向は元品種(Citra)と同じ。",
  "Citra HyperBoost":         "元品種の香りキャラクターを凝縮した濃縮加工品(Cryo/CGX/Lupocore/HyperBoost/Kief/Abstrax等)。基本的なアロマ傾向は元品種(Citra)と同じ。",
  ...
  "Dolcita Abstrax":          "元品種の香りキャラクターを凝縮した濃縮加工品(Cryo/CGX/Lupocore/HyperBoost/Kief/Abstrax等)。基本的なアロマ傾向は元品種(Dolcita)と同じ。",
  ...
  "Krush Lupocore":           "元品種の香りキャラクターを凝縮した濃縮加工品(Cryo/CGX/Lupocore/HyperBoost/Kief/Abstrax等)。基本的なアロマ傾向は元品種(Krush)と同じ。",
  ...
  "Mosaic Lupocore":          "元品種の香りキャラクターを凝縮した濃縮加工品(Cryo/CGX/Lupocore/HyperBoost/Kief/Abstrax等)。基本的なアロマ傾向は元品種(Mosaic)と同じ。",
  ...
  "Motueka Kief":             "元品種の香りキャラクターを凝縮した濃縮加工品(Cryo/CGX/Lupocore/HyperBoost/Kief/Abstrax等)。基本的なアロマ傾向は元品種(Motueka)と同じ。",
  ...
  "Riwaka Cryo":              "元品種の香りキャラクターを凝縮した濃縮加工品(Cryo/CGX/Lupocore/HyperBoost/Kief/Abstrax等)。基本的なアロマ傾向は元品種(Riwaka)と同じ。",
  ...
  "Strata CGX":               "元品種の香りキャラクターを凝縮した濃縮加工品(Cryo/CGX/Lupocore/HyperBoost/Kief/Abstrax等)。基本的なアロマ傾向は元品種(Strata)と同じ。",
  "Strisselspalter":          "スパイス・フローラル・アーシーのフランス・アルザス産伝統品種。",
  "Sultana":                  "Hopsteiner社の実験品種(旧#06277)。パイナップルなど濃厚なトロピカル感と明るいシトラス、松の樹脂感を併せ持つ「大きく粘着質」と評される力強いアロマ。",
  ...
  "Vera":                     "USDA公共品種として2024年に発表されたばかりの新品種。パイナップル風味のライフセイバーズキャンディを思わせる、トロピカル・ストーンフルーツ・キャンディのような柑橘感。",
...
{name:"Chinook CGX",v:[1,3,1,1,4,3]},{name:"Citra",v:[4,5,3,1,1,1]},
{name:"Citra Cryo",v:[4,5,3,1,1,1]},{name:"Citra HyperBoost",v:[4,5,3,1,1,1]},
{name:"Citra Incognito",v:[4,5,3,1,1,1]},{name:"Cluster",v:[0,1,3,3,0,3]},
{name:"Cluster Fugget",v:[1,2,1,1,1,3]},{name:"Columbia",v:[3,4,0,1,0,1]},
{name:"Columbus",v:[0,2,0,1,1,5]},{name:"Columbus Cryo",v:[0,2,0,1,1,5]},
{name:"Comet",v:[1,3,1,1,1,2]},{name:"Contessa",v:[0,2,1,3,0,3]},
{name:"Cryo Pop Original Blend",v:[4,4,3,1,1,0]},{name:"Crystal",v:[1,2,1,3,1,3]},
{name:"Crystal Lupulin",v:[1,2,1,3,1,3]},{name:"CTZ",v:[0,2,0,1,1,4]},
{name:"Dolcita",v:[4,3,3,1,0,1]},{name:"Dolcita Abstrax",v:[4,3,3,1,0,1]},
...
{name:"Krush Lupocore",v:[5,2,4,0,2,2]},{name:"Lemondrop",v:[1,4,1,3,0,3]},
{name:"Liberty",v:[0,2,0,3,0,3]},{name:"Loral",v:[1,3,2,4,0,2]},
{name:"Lorien",v:[2,3,0,3,0,3]},{name:"Magnum",v:[0,2,0,2,1,3]},
{name:"Mandarina Bavaria",v:[2,5,1,2,0,1]},{name:"Millennium",v:[0,1,2,2,3,2]},
{name:"Mosaic",v:[4,3,4,2,2,2]},{name:"Mosaic Cryo",v:[4,3,4,2,2,2]},
{name:"Mosaic Dynaboost",v:[4,3,4,2,2,2]},{name:"Mosaic Incognito",v:[4,3,4,2,2,2]},
{name:"Mosaic Lupocore",v:[4,3,4,2,2,2]},{name:"Motueka",v:[2,5,1,2,0,2]},
{name:"Motueka (MacHops)",v:[2,5,1,2,0,2]},{name:"Motueka (NZ Hops)",v:[2,5,1,2,0,2]},
{name:"Motueka Kief",v:[2,5,1,2,0,2]},{name:"Moutere",v:[4,3,2,1,1,1]},
{name:"Mt. Hood",v:[0,1,0,3,1,3]},{name:"Mt. Rainier",v:[1,2,1,2,2,2]},
{name:"Nectaron",v:[5,4,3,0,0,0]},{name:"Nelson Sauvin",v:[3,2,4,2,0,1]},
...
{name:"Peacharine",v:[2,3,5,2,0,1]},{name:"Pekko",v:[1,3,0,3,0,3]},
{name:"Perle",v:[0,1,0,2,1,3]},{name:"Phoenix",v:[1,1,0,2,2,3]},
{name:"Pilgrim",v:[0,1,2,2,2,3]},{name:"Pilot",v:[0,1,1,1,2,3]},
{name:"Pink Boots Blend",v:[3,4,3,2,1,1]},{name:"Polaris",v:[2,2,0,1,3,4]},
{name:"Premiant",v:[0,1,0,2,0,3]},{name:"Pride of Ringwood",v:[0,0,0,0,2,4]},
{name:"Progress",v:[0,1,2,2,0,3]},{name:"Rakau",v:[2,2,3,1,2,1]},
{name:"Rakau (MacHops)",v:[2,2,3,1,2,1]},{name:"Rakau (NZ Hops)",v:[2,2,3,1,2,1]},
{name:"Riwaka",v:[3,5,1,1,0,1]},{name:"Riwaka Cryo",v:[3,5,1,1,0,1]},
...
{name:"Strata",v:[4,3,3,0,1,3]},{name:"Strata CGX",v:[4,3,3,0,1,3]},
{name:"Strisselspalter",v:[0,1,0,3,0,4]},{name:"Sultana",v:[4,4,1,1,3,1]},
...
{name:"Vanguard",v:[0,1,0,2,1,4]},{name:"Vera",v:[4,3,3,0,0,0]},
{name:"Veterans' Blend",v:[4,3,3,1,1,1]},{name:"Vic Secret",v:[4,1,0,0,4,2]},
{name:"Vista",v:[2,3,2,2,2,2]},{name:"Wai Iti (NZ Hops)",v:[2,3,3,2,0,1]},
{name:"Waimea",v:[2,4,1,1,3,2]},{name:"Wakatu (MacHops)",v:[1,3,0,3,0,2]},
{name:"Wakatu (NZ Hops)",v:[1,3,0,3,0,2]},{name:"Warrior",v:[0,2,0,1,3,2]},
{name:"Willamette",v:[0,1,0,3,1,3]},{name:"Yakima Gold",v:[0,2,0,1,0,2]},
{name:"Zamba",v:[5,3,2,0,0,0]},{name:"Zappa",v:[5,4,1,0,2,2]},
